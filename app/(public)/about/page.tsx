          ...
          {[
            {
              ...
              bio: "With decades of luxury travel experience across New Zealand and the Pacific, Tony brings an encyclopaedic knowledge of the country's best lodges, guides, and hidden experiences. His background with PPG Tours — winners of multiple World Travel Awards — means he's worked with the most discerning travellers in the world and knows exactly how to exceed their expectations.",
            },
            {
              name: "Liam",
      ...
      <Section narrow>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
          {[
            ...
            { stat: "World Travel Award", label: "Multiple-time winners" },
            { stat: "Silversea, Ponant, MSC", label: "Trusted by leading cruise lines" },
          ].map((item) => (
            <div key={item.label}>
              <p className="font-serif text-3xl text-navy tracking-tight">
                {item.stat}
              </p>
