          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <div className="mt-10 flex flex-col sm:flex-row items-start gap-4">
                ...
                <a
                  href="tel:0800287283"
                  className="inline-flex items-center gap-2 px-6 py-3 text-xs tracking-[0.2em] uppercase font-medium
                    text-navy/60 border border-navy/20 hover:border-navy/40 hover:text-navy transition-colors"
                >
