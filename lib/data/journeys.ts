...
By anchoring your experience with a minimum of two nights at each of the country's most storied lodges, we ensure you transition from "tourist" to "guest." From the subtropical elegance of the far North to the dramatic alpine peaks of the deep South, discover the soul of the Islands through bespoke private tours, fine vintage wines & food and landscapes that defy description.`,
    ...
    itinerary: [
      ...
      { day: 3, title: "Bay of Islands to Auckland", description: "After a final morning soak in the coastal air, transfer to Kerikeri for your flight to Auckland. Check into the Park Hyatt Auckland — a refined waterfront sanctuary in the heart of the Viaduct. Browse Commercial Bay and Britomart, or head to the water.", overnight: "Park Hyatt Auckland", highlights: ["Kerikeri scenic flight", "Park Hyatt Auckland"] },
      ...
      { day: 11, title: "High Country Immersion", description: "The Lindis is your private sanctuary in the vast Ahuriri Valley. Choose from heli-hiking with the helicopter landing on your front lawn, horse trekking through pristine alpine valleys, or private art workshops inspired by the 360-degree mountain views.", overnight: "The Lindis", highlights: ["Heli-hiking from the lodge", "Horse trekking", "360° mountain views"], freedomOfChoice: ["Heli-hiking with a glacier landing", "Horse trekking through alpine valleys", "Private art workshop with mountain views", "Stargazing experience in the Mackenzie Dark Sky Reserve"] },
      { day: 12, title: "To the Heart of Queenstown", description: "Transfer to Matakauri Lodge — an intimate lakeside retreat set against the dramatic backdrop of the Remarkables. Settle into your suite and explore Queenstown's vibrant dining scene before your grand finale tomorrow.", overnight: "Matakauri Lodge, Queenstown", highlights: ["Lake Wakatipu views", "Matakauri Lodge"] },
      { day: 13, title: "The Ultimate Fiordland Heli-Odyssey", description: "Board your private helicopter for a definitive exploration of Milford Sound and the West Coast. Soar over hanging glaciers and thundering waterfalls, land on a remote beach for a gourmet picnic, and stand atop an ancient glacier.", overnight: "Matakauri Lodge, Queenstown", highlights: ["Private helicopter Milford Sound", "Remote beach picnic", "Ancient glacier landing"] },
      { day: 14, title: "Queenstown at Leisure", description: "A day for personal discovery. Ascend the Skyline Gondola, explore all Queenstown has to offer, then glide across the lake aboard the historic TSS Earnslaw steamship to Walter Peak for an unforgettable farewell.", overnight: "Matakauri Lodge, Queenstown", highlights: ["TSS Earnslaw cruise", "Walter Peak", "Skyline Gondola"], freedomOfChoice: ["TSS Earnslaw steamship cruise to Walter Peak", "Skyline Gondola and luge", "Queenstown wine trail through Gibbston Valley", "Jet boat on the Shotover River", "Spa afternoon at Matakauri Lodge"] },
